/**
 * Cube.java - <code>SceneObject</code>-extending class defining cube shape
 * Begun 09/07/18
...
/**
 * This class extends <code>SceneObject</code> and defines the cube shape. As this and
 * <code>Floor</code> are both basically the same shape with some minor modifications, the author
...
final class Cube extends SceneObject {
   ...
   */
  protected Cube(Color color, double scale, double translateX, double translateY,
      double translateZ) {
